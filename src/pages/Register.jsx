            ...
            <div className="lg:w-1/2 w-full max-w-md p-8 space-y-3 rounded-xl text-black">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="password" name="password" {...register("password",  { required: true, minLength: 6 })} id="password" placeholder="Password" className="w-full px-4 py-3 rounded-md border-gray-700 text-gray-600 focus:border-violet-400" />
                ...
                <p className="text-xs text-center sm:px-6 text-gray-500">Already have an account?
                    <Link to='/login' className="underline text-gray-700">Login</Link>
                </p>
            </div>
