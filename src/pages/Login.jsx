            ...
            <div className="lg:w-1/2 w-full max-w-md p-8 space-y-3 rounded-xl text-black">
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" ref={captchaRef} name="captcha" id="" placeholder="Type Captcha" className="w-full px-4 py-3 rounded-md border-gray-700 text-gray-600 focus:border-violet-400" />
                ...
                <p className="text-xs text-center sm:px-6 text-gray-500">Don't have an account?
                    <Link to='/register' className="underline text-gray-700">Register</Link>
                </p>
            </div>
